...
show_categories() {
    ...
    echo -e "  ${CYAN}05${NC} - SKILLS-DEVOPS-INFRA        (9 skills)   CI/CD, deploy, Docker, agentes"
    echo -e "  ${CYAN}06${NC} - SKILLS-DOCUMENTOS          (10 skills)  Word, PDF, Excel, PPT"
    echo -e "  ${CYAN}07${NC} - SKILLS-LEGAL-FISCAL        (9 skills)   Contratos, compliance"
    echo -e "  ${CYAN}08${NC} - SKILLS-MARKETING-COPY      (8 skills)   Copy, campañas, SEO"
    echo -e "  ${CYAN}09${NC} - SKILLS-UTILIDADES          (20 skills)  CLI, scraping, git, memoria, meta"
