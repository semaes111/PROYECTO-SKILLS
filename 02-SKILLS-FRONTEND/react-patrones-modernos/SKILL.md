...
ecc-source: skills/react-patterns
...
- React 19 + Server Components: preferir composición server-first; los patrones de cliente de esta skill aplican SOLO dentro de islas `"use client"`.
- UI: **Tailwind CSS 4 + shadcn/ui**. No introducir styled-components ni CSS-in-JS.
- Validación: **Zod** en el borde (Server Actions y Route Handlers), tipos inferidos con `z.infer<>` — nunca duplicar tipos a mano.
